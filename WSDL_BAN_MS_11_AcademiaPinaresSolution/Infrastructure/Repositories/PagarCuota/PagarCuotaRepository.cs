...
namespace Infrastructure.Repositories.PagarCuota
{
    public class PagarCuotaRepository : AEasyDataProcessRepository
    {
        ...
        public override Data DoProcess(ISunitpService _iSunitpService, Data data)
        {
            ...
            //Academia Pinares
            IAcademiaPinaresAdapter iAcademiaPinaresAdapter = new PagarCuotaAdapter();
